...
<body>
    <div class="relative z-0 bg-primary flex h-screen items-center justify-center p-4 overflow-hidden">
        <div class="w-full max-w-md rounded-2xl bg-text-white p-8 shadow-xl border border-gray-100 text-center">
            ...
            {{-- Success --}}
            @if (session('success'))
                <div class="mb-4 text-green-600 text-sm bg-green-50 border border-green-200 rounded-xl px-4 py-3"
            ...
            <form action="{{ route('verify.otp') }}" method="POST">
                ...
                {{-- OTP Boxes --}}
                <div class="flex justify-between gap-2 mb-6" id="otp-inputs" role="group"
                ...
                <div class="text-sm text-gray-500 mb-8">
                    ...
                    <button type="button" id="resend-btn" onclick="document.getElementById('resend-form').submit()"
                        class="cursor-pointer hidden text-blue-600 font-semibold hover:underline
                ...
                {{-- Go Back --}}
                <a href="{{ route('verify.forget') }}" class="text-gray-400 font-bold tracking-wide hover:text-gray-600 transition-colors text-sm">
                    Go Back
                </a>
