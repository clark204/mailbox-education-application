                ...
                <div class="flex flex-col items-center justify-center py-24 px-8 text-center">
                    <div class="relative mb-6">
                        <div class="size-24 rounded-full bg-gray-100 flex items-center justify-center">
                            <x-heroicon-o-document-text class="size-12 text-gray-300" />
                        </div>
                        <div
                            class="absolute -bottom-1 -right-1 size-8 rounded-full bg-violet-50 flex items-center justify-center">
                            <x-heroicon-o-pencil-square class="size-4 text-violet-400" />
                        </div>
                    </div>
                    <h3 class="text-base font-semibold text-gray-700 mb-1">No drafts saved</h3>
                    <p class="text-sm text-gray-400 max-w-xs">Messages you save as drafts will appear here. Start composing to
                        save a draft.</p>
                </div>
            @endforelse
        </ul>
